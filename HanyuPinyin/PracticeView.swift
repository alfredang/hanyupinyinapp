...
enum PracticeCatalog {
    static let sessions: [PracticeSession] = [
        ...
        .init(title: "长信息练习", subtitle: "整句快打 · 可用简拼 · Long messages",
              icon: "text.alignleft", color: Color(red: 0.20, green: 0.42, blue: 0.85),
              prompts: PinyinData.paragraphs),
        .init(title: "ü → v 练习", subtitle: "韵母 ü 打字母 v · Type ü as v",
              icon: "v.circle.fill", color: Color(red: 0.40, green: 0.30, blue: 0.70),
              prompts: PinyinData.vWords),
        .init(title: "限时挑战", subtitle: "60 秒速度挑战 · Speed challenge",
              icon: "timer", color: Color(red: 0.80, green: 0.15, blue: 0.40),
              prompts: PinyinData.characters + PinyinData.words + PinyinData.sentences, timed: 60),
